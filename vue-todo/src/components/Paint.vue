    ...
    <el-container>
      <el-main>
          ...
          <el-divider></el-divider>
            <div class="text item">
              <el-row>
                ...
                <el-col :span="2" v-for="(item, index) in classDatas" :key="index">
                  <span>{{ item.name }}</span>
                </el-col>
              </el-row>
            </div>
        ...
        <!--<el-card class="paintInfo-card"">-->
          ...
          <div>
            <el-row>
              <el-col :span="4" :offset="1" v-for="(image, index) in paintInfo.images" :key="index" class="text item">
                <el-image
                  style="width: 229.500px; height: 149.672px"
                  :src="image.src"
                  :fit="'fit'">
                </el-image>
              </el-col>
...
export default {
  ...
  data () {
    return {
      paintInfos: [
        {pid: '1', nickname: '風滅', icon: 'https://s25.postimg.cc/98r2cyxdr/moe10.png', rate: 3, images: [{src: 'https://cw1.tw/CW/images/article/201608/article-57a06c0800d14.jpg'}, {src: 'https://imgs.gvm.com.tw/upload/gallery/20171128/41252_02.jpg'}]},
        {pid: '2', nickname: '奏夜', icon: 'https://s25.postimg.cc/qysqxzg3j/moe9.png', rate: 5, images: [{src: 'https://cw1.tw/CW/images/article/201608/article-57a06c0800d14.jpg'}]}
      ],
      classDatas: [
        {name: '全部'},
        {name: '排序'}
  ...
  methods: {
    getPaint () {
      let self = this
      self.$axios.get('/api/v1/getPaint', {}).then(function (response) {
