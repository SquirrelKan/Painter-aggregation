      ...
      <el-collapse-item title="個人資料設定" name="1">
        <el-form ref="updateInfo" :model="updateInfo" label-width="120px">
          ...
          <el-form-item label="生日">
            <el-col :span="11">
              <el-date-picker :disabled="isbirthday" type="date" value-format="yyyy-MM-dd" format="yyyy/MM/dd" @change="formatTime" placeholder="Pick a date" v-model="updateInfo.birthday" style="width: 100%;"></el-date-picker>
            </el-col>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    sendData () {
      ...
      self.$axios.post('/api/v1/accountmgt/updateAccountInfo', {
        headers: {
  ...
  created: function () {
    ...
    // let self = this
    self.$axios.get('/api/v1/accountmgt/getAccountInfo', {
      headers: {
        authorization: 'Bearer ' + claims
      }
    }).then(function (response) {
