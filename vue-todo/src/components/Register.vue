  ...
  <div>
    <el-form :model="submitForm" status-icon :rules="rules" ref="submitForm" label-width="100px">
      ...
      <el-form-item label="確認密碼" prop="confirmpassword">
        <el-input type="password" v-model="submitForm.confirmpassword" placeholder="確認密碼" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  methods: {
    onSubmitClick (formName) {
      ...
      if (self.submitForm.username !== '' && self.submitForm.password !== '') {
        self.$axios.post('/api/v1/auth/getUserInfo', {
          ...
          if (data.status === '0001') {
            ...
            console.log('帳號不存在')
            self.$axios.post('/api/v1/auth/register', {
